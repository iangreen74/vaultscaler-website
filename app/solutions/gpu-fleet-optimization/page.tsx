// Route: /solutions/gpu-fleet-optimization (GPU Fleet Optimization Landing Page)
...
export const metadata: Metadata = {
  title: 'GPU Fleet Optimization at Scale | VaultScaler',
  ...
  alternates: {
    canonical: `${SITE.url}/solutions/gpu-fleet-optimization`,
  },
  keywords: [
  ...
  openGraph: {
    ...
    type: 'website',
    url: `${SITE.url}/solutions/gpu-fleet-optimization`,
    images: [{ url: '/og.jpg', width: 1200, height: 630, alt: 'GPU Fleet Optimization at Scale' }],
  },
  twitter: {
...
export default function InfrastructurePage() {
  const pageSchema = {
    ...
    "@type": "WebPage",
    "name": "GPU Fleet Optimization at Scale",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": `${SITE.url}/solutions/gpu-fleet-optimization`
      }
    ]
  };
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Kubernetes, Slurm, and Ray native support</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-pop-dark mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
...
<code>{`# Add VaultScaler Helm repo
$ helm repo add vaultscaler \\
    https://charts.vaultscaler.com

# Install Radix Core
$ helm install radix-core vaultscaler/core \\
...
NAME                    READY   STATUS
radix-controller-0      1/1     Running
radix-scheduler-0       1/1     Running
radix-metrics-0         1/1     Running`}</code>
              </pre>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <TrackedEmailLink
              href="mailto:bpruess@vaultscaler.com?subject=Architecture%20Call%20Request%20-%20GPU%20Fleet%20Optimization"
