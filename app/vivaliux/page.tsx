// Route: /vivaliux (Vivaliux product page — a VaultScaler instrument)
// Re-homed from the former single-page site: the product body lives here under
// the VaultScaler company homepage at /. Hero de-"private"-ified; the yield-as-
// outcome framing has been removed in favour of honest-measurement language.
import type { Metadata } from 'next';
import Link from 'next/link';
import { SITE } from '@/lib/site';
import JsonLd from '@/components/JsonLd';

const TITLE = 'Vivaliux — honest measurement for living systems | VaultScaler';
const DESC =
  'Vivaliux turns a camera into a measuring instrument: it measures what it can honestly see, remembers every reading, and tells you what really changed — and how sure it is. It runs on your own machine; nothing leaves it. A VaultScaler instrument.';

export const metadata: Metadata = {
  title: TITLE,
  description: DESC,
  alternates: { canonical: `${SITE.url}/vivaliux/` },
  keywords: SITE.keywords,
  openGraph: {
    title: TITLE,
    description: DESC,
    type: 'website',
    url: `${SITE.url}/vivaliux/`,
    images: [{ url: '/og-vivaliux.jpg', width: 1200, height: 630, alt: 'Vivaliux — honest measurement for living systems, a VaultScaler instrument' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: TITLE,
    description: DESC,
    images: ['/og-vivaliux.jpg'],
  },
};
...
const trust = [
  ...
  {
    h: 'Runs on hardware you own',
    b: 'Capture, measurement, and memory run on hardware you control. Nothing is sent anywhere unless you choose to. Your data never leaves your machine — that’s the architecture, not a setting.',
  },
  {
...
const pricingRows: { feature: string; cells: [string, string, string] }[] = [
  ...
  { feature: 'Toward earned prediction', cells: ['—', '—', '✓'] },
...
export default function Vivaliux() {
  const productSchema = {
    ...
    description: DESC,
    publisher: { '@type': 'Organization', name: 'VaultScaler', url: `${SITE.url}/` },
  };
  ...
  return (
    <>
      ...
      <section className="relative min-h-[clamp(520px,62vh,820px)] flex items-center bg-gradient-to-br from-primary-4 via-primary-3 to-primary-3 overflow-hidden pt-12 pb-16">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl">
            <Link
              href="/"
              className="inline-flex items-center gap-1.5 text-primary-1 hover:text-white text-sm font-medium mb-6 transition-colors"
            >
              <span aria-hidden>←</span> VaultScaler
            </Link>
            <p className="text-pop-light text-sm font-semibold uppercase tracking-wide mb-4">
              Vivaliux · a VaultScaler instrument
            </p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 tracking-tight leading-tight">
              Honest measurement for living systems.
            </h1>
      ...
      {/* The honest-measurement thesis — connective narrative band */}
      <section className="bg-primary-4 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xl sm:text-2xl text-white font-semibold leading-snug mb-4">
            Every good decision about a living system starts with a measurement you can trust.
          </p>
          <p className="text-lg text-primary-1 leading-relaxed">
            ...
            reading, and coaches you to better data. Trustworthy information is the foundation under
            every decision you make — so we start there, and we get deeper at it over time, with you.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary-3">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
            ...
            what honest, local, evidence-grade measurement can do for it.
          </p>
